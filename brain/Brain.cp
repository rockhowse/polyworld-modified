...
#else
#define __ALLOC_STACK_BUFFER(NAME, TYPE, N) boost::shared_array< TYPE > NAME( new TYPE[ N ] );
#endif
...
//---------------------------------------------------------------------------
void Brain::GrowDesignedBrain( genome::Genome* g )
{
	mygenes = g;
	this->cns = cns;
...
// Brain::Grow
//---------------------------------------------------------------------------
void Brain::Grow( genome::Genome* g )
{
#ifdef DEBUGCHECK
